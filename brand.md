...
## Logo — FINAL (set 2026-06-18)
- **Mark:** the stylized vintage barber chair Ashley generated (source
  `chairside-logos/IMG_8165.png`), cleaned to brand palette — olive bg
  normalized to `#15140f`, AI sparkle stripped, kept the native two-tone gold.
- **Lockup:** chair + Bebas Neue `CHAIR`**`SIDE`** / `BARBER SITES`.
- **Production assets** (generated by `scripts/build-chairside-brand.js`):
  - Site header mark (transparent): `chairside-site/assets/chair-mark.png`
  - Favicons: `favicon.ico` (16+32), `favicon-16/32.png`, `apple-touch-icon.png`
  - Social: `og.png` (1200×630 lockup card)
  - Brand: `chairside-logos/logo-lockup-dark.png` + `-light.png`, `ig-profile-320.png`
- Tiny-favicon note: the detailed chair muddies at 16–32px (Ashley accepted
  this 2026-06-18 — kept the detailed chair rather than a simplified glyph).
