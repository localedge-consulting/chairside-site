...
## Type
- **Display / wordmark:** Bebas Neue (condensed barber-poster) OR Oswald
- **Premium serif option:** Cormorant Garamond (for an upscale wordmark)
- **Body:** Inter

## Logo
- Direction: **stylized barber chair** (preferred, per Ashley) — vintage
  illustration vibe. Generate via Magnific/Leonardo, recolor to palette.
  Fallback: the fading-barber-pole mark (`chairside-logos/pole-mark-amber.png`)
  or the hand-SVG chair (`chair-mark-solid.png`).
- Favicon + IG profile pic come from the final mark.
